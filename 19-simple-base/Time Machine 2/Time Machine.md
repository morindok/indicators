...
فایل اصلی: [`Time Machine 2/Time Machine.txt`](Time Machine 2/Time Machine.txt)

## 📖 معرفی
**Time Machine** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
