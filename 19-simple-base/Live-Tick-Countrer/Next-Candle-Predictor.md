...
Source file: [`Live-Tick-Countrer/Next-Candle-Predictor.txt`](Live-Tick-Countrer/Next-Candle-Predictor.txt)

## Overview

**Next-Candle-Predictor** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
