# Live-Tick-Counter-v6

> Category: [Simple Base](README.md) - Base indicators - shapes, spirals, tick counters.

Source file: [`Live-Tick-Countrer/Live-Tick-Counter-v6.txt`](Live-Tick-Countrer/Live-Tick-Counter-v6.txt)

## Overview

**Live-Tick-Counter-v6** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
