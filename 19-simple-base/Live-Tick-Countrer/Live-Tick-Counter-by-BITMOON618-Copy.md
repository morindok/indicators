# Live-Tick-Counter-by-BITMOON618-Copy

> Category: [Simple Base](README.md) - Base indicators - shapes, spirals, tick counters.

Source file: [`Live-Tick-Countrer/Live-Tick-Counter-by-BITMOON618-Copy.txt`](Live-Tick-Countrer/Live-Tick-Counter-by-BITMOON618-Copy.txt)

## Overview

**Live-Tick-Counter-by-BITMOON618-Copy** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
