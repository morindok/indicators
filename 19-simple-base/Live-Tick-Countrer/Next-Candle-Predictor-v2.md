...
Source file: [`Live-Tick-Countrer/Next-Candle-Predictor-v2.txt`](Live-Tick-Countrer/Next-Candle-Predictor-v2.txt)

## Overview

**Next-Candle-Predictor-v2** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
