...
فایل اصلی: [`Mirror Oscilator Price.txt`](Mirror Oscilator Price.txt)

## 📖 معرفی
**Mirror Oscilator Price** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
