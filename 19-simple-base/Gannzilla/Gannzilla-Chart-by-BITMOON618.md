# Gannzilla-Chart-by-BITMOON618

> Category: [Simple Base](README.md) - Base indicators - shapes, spirals, tick counters.

Source file: [`Gannzilla/Gannzilla-Chart-by-BITMOON618.txt`](Gannzilla/Gannzilla-Chart-by-BITMOON618.txt)

## Overview

**Gannzilla-Chart-by-BITMOON618** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
