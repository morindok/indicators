...
فایل اصلی: [`Gannzilla/Gannzilla Chart by BITMOON618.txt`](Gannzilla/Gannzilla Chart by BITMOON618.txt)

## 📖 معرفی
**Gannzilla Chart by BITMOON618** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
