...
Source file: [`symmetry-4-points.txt`](symmetry-4-points.txt)

## Overview

**symmetry-4-points** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
