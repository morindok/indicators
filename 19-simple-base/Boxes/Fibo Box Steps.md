...
فایل اصلی: [`Boxes/Fibo Box Steps.txt`](Boxes/Fibo Box Steps.txt)

## 📖 معرفی
**Fibo Box Steps** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
