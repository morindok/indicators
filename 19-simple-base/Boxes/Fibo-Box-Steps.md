...
Source file: [`Boxes/Fibo-Box-Steps.txt`](Boxes/Fibo-Box-Steps.txt)

## Overview

**Fibo-Box-Steps** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
