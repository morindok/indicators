...
فایل اصلی: [`Tagnet Circle Mirror.txt`](Tagnet Circle Mirror.txt)

## 📖 معرفی
**Tagnet Circle Mirror** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
