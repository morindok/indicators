...
فایل اصلی: [`Bmoon System Order Block.txt`](Bmoon System Order Block.txt)

## 📖 معرفی
**Bmoon System Order Block** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
