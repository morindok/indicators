...
Source file: [`Simple-Time-Mirror-Fractals.txt`](Simple-Time-Mirror-Fractals.txt)

## Overview

**Simple-Time-Mirror-Fractals** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
