...
فایل اصلی: [`Zero-Lag Ma by BITMOON618.txt`](Zero-Lag Ma by BITMOON618.txt)

## 📖 معرفی
**Zero Lag Ma by BITMOON618** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
