...
فایل اصلی: [`Spiral Symmetric/Strategy Spiral Symmetric.txt`](Spiral Symmetric/Strategy Spiral Symmetric.txt)

## 📖 معرفی
**Strategy Spiral Symmetric** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
