...
فایل اصلی: [`Spiral Symmetric/Spiral Symmetric V2.txt`](Spiral Symmetric/Spiral Symmetric V2.txt)

## 📖 معرفی
**Spiral Symmetric V2** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
