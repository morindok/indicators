...
فایل اصلی: [`Spiral Symmetric/Spirals/Hhll Spirals.txt`](Spiral Symmetric/Spirals/Hhll Spirals.txt)

## 📖 معرفی
**Hhll Spirals** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
