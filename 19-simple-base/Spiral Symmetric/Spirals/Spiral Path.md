...
فایل اصلی: [`Spiral Symmetric/Spirals/Spiral Path.txt`](Spiral Symmetric/Spirals/Spiral Path.txt)

## 📖 معرفی
**Spiral Path** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
