...
فایل اصلی: [`Spiral Symmetric/Convergenc Spirals.txt`](Spiral Symmetric/Convergenc Spirals.txt)

## 📖 معرفی
**Convergenc Spirals** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
