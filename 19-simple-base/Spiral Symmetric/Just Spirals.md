...
فایل اصلی: [`Spiral Symmetric/Just Spirals.txt`](Spiral Symmetric/Just Spirals.txt)

## 📖 معرفی
**Just Spirals** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
