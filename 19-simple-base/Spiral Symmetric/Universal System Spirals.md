...
فایل اصلی: [`Spiral Symmetric/Universal System Spirals.txt`](Spiral Symmetric/Universal System Spirals.txt)

## 📖 معرفی
**Universal System Spirals** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
