...
فایل اصلی: [`Spiral Symmetric/Spiral Symmetric - v3.txt`](Spiral Symmetric/Spiral Symmetric - v3.txt)

## 📖 معرفی
**Spiral Symmetric   v3** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
