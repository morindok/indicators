...
Source file: [`Mirror-Oscilator.txt`](Mirror-Oscilator.txt)

## Overview

**Mirror-Oscilator** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
