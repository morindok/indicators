...
فایل اصلی: [`Bmoon System Pivot Finder - V3.txt`](Bmoon System Pivot Finder - V3.txt)

## 📖 معرفی
**Bmoon System Pivot Finder   V3** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
