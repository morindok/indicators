...
Source file: [`Offset-Prices-V2.txt`](Offset-Prices-V2.txt)

## Overview

**Offset-Prices-V2** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
