...
فایل اصلی: [`Mirror Oscilator by BITMOON618.txt`](Mirror Oscilator by BITMOON618.txt)

## 📖 معرفی
**Mirror Oscilator by BITMOON618** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
