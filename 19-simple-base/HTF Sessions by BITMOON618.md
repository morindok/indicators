...
فایل اصلی: [`HTF Sessions by BITMOON618.txt`](HTF Sessions by BITMOON618.txt)

## 📖 معرفی
**HTF Sessions by BITMOON618** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
