...
فایل اصلی: [`symmetry 4 points.txt`](symmetry 4 points.txt)

## 📖 معرفی
**symmetry 4 points** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
