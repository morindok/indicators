...
فایل اصلی: [`Spiral Pro by BITMOON618.txt`](Spiral Pro by BITMOON618.txt)

## 📖 معرفی
**Spiral Pro by BITMOON618** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
