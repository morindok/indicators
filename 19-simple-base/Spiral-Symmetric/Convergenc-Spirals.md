...
Source file: [`Spiral-Symmetric/Convergenc-Spirals.txt`](Spiral-Symmetric/Convergenc-Spirals.txt)

## Overview

**Convergenc-Spirals** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
