...
Source file: [`Spiral-Symmetric/Spiral-Symmetric.txt`](Spiral-Symmetric/Spiral-Symmetric.txt)

## Overview

**Spiral-Symmetric** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
