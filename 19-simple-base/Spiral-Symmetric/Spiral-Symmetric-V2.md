...
Source file: [`Spiral-Symmetric/Spiral-Symmetric-V2.txt`](Spiral-Symmetric/Spiral-Symmetric-V2.txt)

## Overview

**Spiral-Symmetric-V2** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
