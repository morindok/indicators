# Spiral-Symmetric-Signals-Morindok

> Category: [Simple Base](README.md) - Base indicators - shapes, spirals, tick counters.

Source file: [`Spiral-Symmetric/Spiral-Symmetric-Signals-Morindok.txt`](Spiral-Symmetric/Spiral-Symmetric-Signals-Morindok.txt)

## Overview

**Spiral-Symmetric-Signals-Morindok** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
