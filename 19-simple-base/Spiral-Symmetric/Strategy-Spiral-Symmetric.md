# Strategy-Spiral-Symmetric

> Category: [Simple Base](README.md) - Base indicators - shapes, spirals, tick counters.

Source file: [`Spiral-Symmetric/Strategy-Spiral-Symmetric.txt`](Spiral-Symmetric/Strategy-Spiral-Symmetric.txt)

## Overview

**Strategy-Spiral-Symmetric** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
