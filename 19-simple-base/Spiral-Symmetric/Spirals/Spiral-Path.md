...
Source file: [`Spiral-Symmetric/Spirals/Spiral-Path.txt`](Spiral-Symmetric/Spirals/Spiral-Path.txt)

## Overview

**Spiral-Path** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
