...
Source file: [`Spiral-Symmetric/Just-Spirals.txt`](Spiral-Symmetric/Just-Spirals.txt)

## Overview

**Just-Spirals** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
