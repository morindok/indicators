...
Source file: [`Spiral-Symmetric/Spiral-Symmetric-v3.txt`](Spiral-Symmetric/Spiral-Symmetric-v3.txt)

## Overview

**Spiral-Symmetric-v3** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
