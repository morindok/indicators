...
فایل اصلی: [`Fractal Symmetric Circles.txt`](Fractal Symmetric Circles.txt)

## 📖 معرفی
**Fractal Symmetric Circles** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
