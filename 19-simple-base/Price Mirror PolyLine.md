...
فایل اصلی: [`Price Mirror PolyLine.txt`](Price Mirror PolyLine.txt)

## 📖 معرفی
**Price Mirror PolyLine** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
