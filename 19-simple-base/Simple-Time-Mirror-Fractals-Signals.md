# Simple-Time-Mirror-Fractals-Signals

> Category: [Simple Base](README.md) - Base indicators - shapes, spirals, tick counters.

Source file: [`Simple-Time-Mirror-Fractals-Signals.txt`](Simple-Time-Mirror-Fractals-Signals.txt)

## Overview

**Simple-Time-Mirror-Fractals-Signals** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
