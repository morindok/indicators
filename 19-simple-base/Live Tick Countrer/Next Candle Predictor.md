...
فایل اصلی: [`Live Tick Countrer/Next Candle Predictor.txt`](Live Tick Countrer/Next Candle Predictor.txt)

## 📖 معرفی
**Next Candle Predictor** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
