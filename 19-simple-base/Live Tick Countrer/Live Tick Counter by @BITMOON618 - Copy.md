...
فایل اصلی: [`Live Tick Countrer/Live Tick Counter by @BITMOON618 - Copy.txt`](Live Tick Countrer/Live Tick Counter by @BITMOON618 - Copy.txt)

## 📖 معرفی
**Live Tick Counter by @BITMOON618   Copy** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
