...
فایل اصلی: [`Live Tick Countrer/Live Tick Counter v6.txt`](Live Tick Countrer/Live Tick Counter v6.txt)

## 📖 معرفی
**Live Tick Counter v6** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
