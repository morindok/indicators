...
فایل اصلی: [`Live Tick Countrer/Live Tick Counter by @BITMOON618 V4.txt`](Live Tick Countrer/Live Tick Counter by @BITMOON618 V4.txt)

## 📖 معرفی
**Live Tick Counter by @BITMOON618 V4** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
