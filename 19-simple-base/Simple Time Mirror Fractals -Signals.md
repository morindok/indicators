...
فایل اصلی: [`Simple Time Mirror Fractals -Signals.txt`](Simple Time Mirror Fractals -Signals.txt)

## 📖 معرفی
**Simple Time Mirror Fractals  Signals** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
