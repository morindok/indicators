# Price-Mirror-PolyLine

> Category: [Simple Base](README.md) - Base indicators - shapes, spirals, tick counters.

Source file: [`Price-Mirror-PolyLine.txt`](Price-Mirror-PolyLine.txt)

## Overview

**Price-Mirror-PolyLine** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
