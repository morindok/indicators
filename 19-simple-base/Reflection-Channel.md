...
Source file: [`Reflection-Channel.txt`](Reflection-Channel.txt)

## Overview

**Reflection-Channel** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
