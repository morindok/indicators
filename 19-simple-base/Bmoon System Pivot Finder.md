...
فایل اصلی: [`Bmoon System Pivot Finder.txt`](Bmoon System Pivot Finder.txt)

## 📖 معرفی
**Bmoon System Pivot Finder** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
