...
فایل اصلی: [`Bmoon System Order Block - V2.txt`](Bmoon System Order Block - V2.txt)

## 📖 معرفی
**Bmoon System Order Block   V2** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
