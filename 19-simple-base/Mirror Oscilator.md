...
فایل اصلی: [`Mirror Oscilator.txt`](Mirror Oscilator.txt)

## 📖 معرفی
**Mirror Oscilator** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
