...
فایل اصلی: [`Bmoon System V5 - Signals.txt`](Bmoon System V5 - Signals.txt)

## 📖 معرفی
**Bmoon System V5   Signals** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
