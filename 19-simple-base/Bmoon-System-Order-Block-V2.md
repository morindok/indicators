# Bmoon-System-Order-Block-V2

> Category: [Simple Base](README.md) - Base indicators - shapes, spirals, tick counters.

Source file: [`Bmoon-System-Order-Block-V2.txt`](Bmoon-System-Order-Block-V2.txt)

## Overview

**Bmoon-System-Order-Block-V2** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
