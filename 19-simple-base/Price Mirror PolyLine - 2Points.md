...
فایل اصلی: [`Price Mirror PolyLine - 2Points.txt`](Price Mirror PolyLine - 2Points.txt)

## 📖 معرفی
**Price Mirror PolyLine   2Points** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
