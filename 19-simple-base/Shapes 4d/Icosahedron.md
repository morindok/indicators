...
فایل اصلی: [`Shapes 4d/Icosahedron.txt`](Shapes 4d/Icosahedron.txt)

## 📖 معرفی
**Icosahedron** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
