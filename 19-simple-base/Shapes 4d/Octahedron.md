...
فایل اصلی: [`Shapes 4d/Octahedron.txt`](Shapes 4d/Octahedron.txt)

## 📖 معرفی
**Octahedron** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
