...
فایل اصلی: [`Shapes 4d/HyperCube by BITMOON618.txt`](Shapes 4d/HyperCube by BITMOON618.txt)

## 📖 معرفی
**HyperCube by BITMOON618** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
