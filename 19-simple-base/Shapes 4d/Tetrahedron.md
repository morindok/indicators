...
فایل اصلی: [`Shapes 4d/Tetrahedron.txt`](Shapes 4d/Tetrahedron.txt)

## 📖 معرفی
**Tetrahedron** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
