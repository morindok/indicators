...
فایل اصلی: [`2Point Selelctor.txt`](2Point Selelctor.txt)

## 📖 معرفی
**2Point Selelctor** یکی از اندیکاتورهای دسته «Simple Base» است. اندیکاتورهای پایه — اشکال، اسپیرال، شمارنده تیک
