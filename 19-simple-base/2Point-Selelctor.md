...
Source file: [`2Point-Selelctor.txt`](2Point-Selelctor.txt)

## Overview

**2Point-Selelctor** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
