# Bmoon-System-Pivot-Finder-V3

> Category: [Simple Base](README.md) - Base indicators - shapes, spirals, tick counters.

Source file: [`Bmoon-System-Pivot-Finder-V3.txt`](Bmoon-System-Pivot-Finder-V3.txt)

## Overview

**Bmoon-System-Pivot-Finder-V3** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
