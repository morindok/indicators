...
Source file: [`Shapes-4d/Icosahedron.txt`](Shapes-4d/Icosahedron.txt)

## Overview

**Icosahedron** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
