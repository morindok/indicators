...
Source file: [`Shapes-4d/Tetrahedron.txt`](Shapes-4d/Tetrahedron.txt)

## Overview

**Tetrahedron** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
