...
Source file: [`Shapes-4d/Octahedron.txt`](Shapes-4d/Octahedron.txt)

## Overview

**Octahedron** belongs to the *Simple Base* category. Base indicators - shapes, spirals, tick counters.
