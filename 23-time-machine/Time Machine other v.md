...
فایل اصلی: [`Time Machine other v.txt`](Time Machine other v.txt)

## 📖 معرفی
**Time Machine other v** یکی از اندیکاتورهای دسته «Time Machine» است. ماشین زمان — بازتاب تاریخی قیمت و پروجکشن
