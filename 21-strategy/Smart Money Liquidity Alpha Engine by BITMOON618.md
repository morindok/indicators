...
> دسته: [Strategy](README.md) — استراتژی‌های معاملاتی — نقدینگی و Smart Money

فایل اصلی: [`Smart Money Liquidity Alpha Engine by BITMOON618.txt`](Smart Money Liquidity Alpha Engine by BITMOON618.txt)

## 📖 معرفی
**Smart Money Liquidity Alpha Engine by BITMOON618** یکی از اندیکاتورهای دسته «Strategy» است. استراتژی‌های معاملاتی — نقدینگی و Smart Money
