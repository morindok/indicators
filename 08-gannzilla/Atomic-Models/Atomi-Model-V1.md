...
Source file: [`Atomic-Models/Atomi-Model-V1.txt`](Atomic-Models/Atomi-Model-V1.txt)

## Overview

**Atomi-Model-V1** belongs to the *Gannzilla* category. W.D. Gann tools - Square of 9, Gann Machine, Atomic Models.
