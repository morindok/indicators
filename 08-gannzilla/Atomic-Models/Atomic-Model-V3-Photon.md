# Atomic-Model-V3-Photon

> Category: [Gannzilla](README.md) - W.D. Gann tools - Square of 9, Gann Machine, Atomic Models.

Source file: [`Atomic-Models/Atomic-Model-V3-Photon.txt`](Atomic-Models/Atomic-Model-V3-Photon.txt)

## Overview

**Atomic-Model-V3-Photon** belongs to the *Gannzilla* category. W.D. Gann tools - Square of 9, Gann Machine, Atomic Models.
