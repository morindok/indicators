...
فایل اصلی: [`Atomic Models/Atomic Model V3 Photon.txt`](Atomic Models/Atomic Model V3 Photon.txt)

## 📖 معرفی
**Atomic Model V3 Photon** یکی از اندیکاتورهای دسته «Gannzilla» است. ابزارهای W.D. Gann — مربع ۹، ماشین گن، مدل‌های اتمی
