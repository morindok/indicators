# Atomic Model V2 Combination

> دسته: [Gannzilla](README.md) — ابزارهای W.D. Gann — مربع ۹، ماشین گن، مدل‌های اتمی

فایل اصلی: [`Atomic Models/Atomic Model V2 Combination.txt`](Atomic Models/Atomic Model V2 Combination.txt)

## 📖 معرفی
**Atomic Model V2 Combination** یکی از اندیکاتورهای دسته «Gannzilla» است. ابزارهای W.D. Gann — مربع ۹، ماشین گن، مدل‌های اتمی
