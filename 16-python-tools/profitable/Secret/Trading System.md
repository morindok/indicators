...
فایل اصلی: [`profitable/Secret/Trading System.py`](profitable/Secret/Trading System.py)

## 📖 معرفی
**Trading System** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
