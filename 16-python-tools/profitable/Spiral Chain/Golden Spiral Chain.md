...
فایل اصلی: [`profitable/Spiral Chain/Golden Spiral Chain.txt`](profitable/Spiral Chain/Golden Spiral Chain.txt)

## 📖 معرفی
**Golden Spiral Chain** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
