...
فایل اصلی: [`profitable/Regime-Aware Pro Trader.txt`](profitable/Regime-Aware Pro Trader.txt)

## 📖 معرفی
**Regime Aware Pro Trader** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
