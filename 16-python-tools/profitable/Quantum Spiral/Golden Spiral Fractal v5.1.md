...
فایل اصلی: [`profitable/Quantum Spiral/Golden Spiral Fractal v5.1.txt`](profitable/Quantum Spiral/Golden Spiral Fractal v5.1.txt)

## 📖 معرفی
**Golden Spiral Fractal v5.1** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
