...
فایل اصلی: [`profitable/Golden Spiral Fractal LIVE Trader v3.py`](profitable/Golden Spiral Fractal LIVE Trader v3.py)

## 📖 معرفی
**Golden Spiral Fractal LIVE Trader v3** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
