# Golden-Spiral-Fractal-LIVE-Trader-v3

> Category: [Python Tools](README.md) - Python utilities - clock, spiral, footprint, Gann, neural tools.

Source file: [`profitable/Golden-Spiral-Fractal-LIVE-Trader-v3.py`](profitable/Golden-Spiral-Fractal-LIVE-Trader-v3.py)

## Overview

**Golden-Spiral-Fractal-LIVE-Trader-v3** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "profitable/Golden-Spiral-Fractal-LIVE-Trader-v3.py"
```
