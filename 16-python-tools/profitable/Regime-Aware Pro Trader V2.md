...
فایل اصلی: [`profitable/Regime-Aware Pro Trader V2.txt`](profitable/Regime-Aware Pro Trader V2.txt)

## 📖 معرفی
**Regime Aware Pro Trader V2** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
