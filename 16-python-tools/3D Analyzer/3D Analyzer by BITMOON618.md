...
فایل اصلی: [`3D Analyzer/3D Analyzer by BITMOON618.txt`](3D Analyzer/3D Analyzer by BITMOON618.txt)

## 📖 معرفی
**3D Analyzer by BITMOON618** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
