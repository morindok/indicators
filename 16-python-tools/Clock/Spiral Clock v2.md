...
فایل اصلی: [`Clock/Spiral Clock v2.py`](Clock/Spiral Clock v2.py)

## 📖 معرفی
**Spiral Clock v2** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
