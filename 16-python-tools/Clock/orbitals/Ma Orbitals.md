...
فایل اصلی: [`Clock/orbitals/Ma Orbitals.py`](Clock/orbitals/Ma Orbitals.py)

## 📖 معرفی
**Ma Orbitals** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
