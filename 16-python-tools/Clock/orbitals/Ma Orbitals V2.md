...
فایل اصلی: [`Clock/orbitals/Ma Orbitals V2.py`](Clock/orbitals/Ma Orbitals V2.py)

## 📖 معرفی
**Ma Orbitals V2** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
