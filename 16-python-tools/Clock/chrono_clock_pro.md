...
فایل اصلی: [`Clock/chrono_clock_pro.py`](Clock/chrono_clock_pro.py)

## 📖 معرفی
**chrono_clock_pro** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
