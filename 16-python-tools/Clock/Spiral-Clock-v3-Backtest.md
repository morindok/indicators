...
Source file: [`Clock/Spiral-Clock-v3-Backtest.py`](Clock/Spiral-Clock-v3-Backtest.py)

## Overview

**Spiral-Clock-v3-Backtest** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
