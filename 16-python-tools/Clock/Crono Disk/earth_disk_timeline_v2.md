...
فایل اصلی: [`Clock/Crono Disk/earth_disk_timeline_v2.py`](Clock/Crono Disk/earth_disk_timeline_v2.py)

## 📖 معرفی
**earth_disk_timeline_v2** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
