...
فایل اصلی: [`Clock/Crono Disk/Multi-Disk Timeline Pro + Live Scanner.txt`](Clock/Crono Disk/Multi-Disk Timeline Pro + Live Scanner.txt)

## 📖 معرفی
**Multi Disk Timeline Pro + Live Scanner** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
