...
فایل اصلی: [`Clock/Crono Disk/chrono_matrix_3d.py`](Clock/Crono Disk/chrono_matrix_3d.py)

## 📖 معرفی
**chrono_matrix_3d** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
