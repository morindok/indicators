...
فایل اصلی: [`Clock/Crono Disk/chrono_disc_timeline.py`](Clock/Crono Disk/chrono_disc_timeline.py)

## 📖 معرفی
**chrono_disc_timeline** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
