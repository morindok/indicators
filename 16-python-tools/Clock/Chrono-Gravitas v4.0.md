...
فایل اصلی: [`Clock/Chrono-Gravitas v4.0.py`](Clock/Chrono-Gravitas v4.0.py)

## 📖 معرفی
**Chrono Gravitas v4.0** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
