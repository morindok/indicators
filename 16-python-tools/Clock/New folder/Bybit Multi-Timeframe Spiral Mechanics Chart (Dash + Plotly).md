...
فایل اصلی: [`Clock/New folder/Bybit Multi-Timeframe Spiral Mechanics Chart (Dash + Plotly).txt`](Clock/New folder/Bybit Multi-Timeframe Spiral Mechanics Chart (Dash + Plotly).txt)

## 📖 معرفی
**Bybit Multi Timeframe Spiral Mechanics Chart (Dash + Plotly)** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
