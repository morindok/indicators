...
فایل اصلی: [`Clock/spiral/Hierarchical Spiral + Fibonacci Orbits.txt`](Clock/spiral/Hierarchical Spiral + Fibonacci Orbits.txt)

## 📖 معرفی
**Hierarchical Spiral + Fibonacci Orbits** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
