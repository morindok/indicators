...
فایل اصلی: [`Clock/spiral/Golden Spiral Chain by BITMOON618.py`](Clock/spiral/Golden Spiral Chain by BITMOON618.py)

## 📖 معرفی
**Golden Spiral Chain by BITMOON618** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
