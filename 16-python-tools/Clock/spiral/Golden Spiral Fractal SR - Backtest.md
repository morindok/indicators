...
فایل اصلی: [`Clock/spiral/Golden Spiral Fractal SR - Backtest.py`](Clock/spiral/Golden Spiral Fractal SR - Backtest.py)

## 📖 معرفی
**Golden Spiral Fractal SR   Backtest** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
