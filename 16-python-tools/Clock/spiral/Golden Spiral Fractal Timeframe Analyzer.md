...
فایل اصلی: [`Clock/spiral/Golden Spiral Fractal Timeframe Analyzer.txt`](Clock/spiral/Golden Spiral Fractal Timeframe Analyzer.txt)

## 📖 معرفی
**Golden Spiral Fractal Timeframe Analyzer** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
