...
فایل اصلی: [`Clock/spiral/Golden Spiral Fractal SR.py`](Clock/spiral/Golden Spiral Fractal SR.py)

## 📖 معرفی
**Golden Spiral Fractal SR** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
