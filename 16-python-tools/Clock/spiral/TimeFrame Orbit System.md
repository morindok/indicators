...
فایل اصلی: [`Clock/spiral/TimeFrame Orbit System.py`](Clock/spiral/TimeFrame Orbit System.py)

## 📖 معرفی
**TimeFrame Orbit System** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
