...
فایل اصلی: [`Clock/spiral/Golden Fractal Spiral.py`](Clock/spiral/Golden Fractal Spiral.py)

## 📖 معرفی
**Golden Fractal Spiral** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
