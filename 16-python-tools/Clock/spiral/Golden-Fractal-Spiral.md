# Golden-Fractal-Spiral

> Category: [Python Tools](README.md) - Python utilities - clock, spiral, footprint, Gann, neural tools.

Source file: [`Clock/spiral/Golden-Fractal-Spiral.py`](Clock/spiral/Golden-Fractal-Spiral.py)

## Overview

**Golden-Fractal-Spiral** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "Clock/spiral/Golden-Fractal-Spiral.py"
```
