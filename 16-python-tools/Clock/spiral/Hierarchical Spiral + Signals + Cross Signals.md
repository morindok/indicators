...
فایل اصلی: [`Clock/spiral/Hierarchical Spiral + Signals + Cross Signals.txt`](Clock/spiral/Hierarchical Spiral + Signals + Cross Signals.txt)

## 📖 معرفی
**Hierarchical Spiral + Signals + Cross Signals** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
