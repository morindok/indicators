...
فایل اصلی: [`Clock/spiral/Bybit Spiral Timeframes Dashboard.txt`](Clock/spiral/Bybit Spiral Timeframes Dashboard.txt)

## 📖 معرفی
**Bybit Spiral Timeframes Dashboard** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
