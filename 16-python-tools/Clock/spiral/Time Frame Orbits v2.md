...
فایل اصلی: [`Clock/spiral/Time Frame Orbits v2.txt`](Clock/spiral/Time Frame Orbits v2.txt)

## 📖 معرفی
**Time Frame Orbits v2** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
