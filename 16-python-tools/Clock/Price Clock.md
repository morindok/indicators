...
فایل اصلی: [`Clock/Price Clock.txt`](Clock/Price Clock.txt)

## 📖 معرفی
**Price Clock** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
