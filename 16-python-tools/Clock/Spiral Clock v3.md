...
فایل اصلی: [`Clock/Spiral Clock v3.py`](Clock/Spiral Clock v3.py)

## 📖 معرفی
**Spiral Clock v3** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
