...
فایل اصلی: [`Clock/Chrono-Gravitas v2.0.txt`](Clock/Chrono-Gravitas v2.0.txt)

## 📖 معرفی
**Chrono Gravitas v2.0** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
