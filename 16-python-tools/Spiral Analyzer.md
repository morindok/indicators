...
فایل اصلی: [`Spiral Analyzer.txt`](Spiral Analyzer.txt)

## 📖 معرفی
**Spiral Analyzer** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
