...
فایل اصلی: [`quant/v2/claude_quant.py`](quant/v2/claude_quant.py)

## 📖 معرفی
**claude_quant** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
