...
فایل اصلی: [`Harmonic Circles.txt`](Harmonic Circles.txt)

## 📖 معرفی
**Harmonic Circles** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
