...
Source file: [`Neural-Network/path_simulator.py`](Neural-Network/path_simulator.py)

## Overview

**path_simulator** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "Neural-Network/path_simulator.py"
```
