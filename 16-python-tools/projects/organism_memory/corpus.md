...
فایل اصلی: [`projects/organism_memory/corpus.txt`](projects/organism_memory/corpus.txt)

## 📖 معرفی
**corpus** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
