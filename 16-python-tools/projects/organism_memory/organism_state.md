...
فایل اصلی: [`projects/organism_memory/organism_state.json`](projects/organism_memory/organism_state.json)

## 📖 معرفی
**organism_state** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
