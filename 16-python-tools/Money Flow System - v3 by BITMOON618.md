...
فایل اصلی: [`Money Flow System - v3 by BITMOON618.txt`](Money Flow System - v3 by BITMOON618.txt)

## 📖 معرفی
**Money Flow System   v3 by BITMOON618** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
