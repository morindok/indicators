...
فایل اصلی: [`Neural Network/app_state.py`](Neural Network/app_state.py)

## 📖 معرفی
**app_state** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
