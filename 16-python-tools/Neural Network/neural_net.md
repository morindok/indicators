...
فایل اصلی: [`Neural Network/neural_net.py`](Neural Network/neural_net.py)

## 📖 معرفی
**neural_net** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
