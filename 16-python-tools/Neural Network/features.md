...
فایل اصلی: [`Neural Network/features.py`](Neural Network/features.py)

## 📖 معرفی
**features** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
