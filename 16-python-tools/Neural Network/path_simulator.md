...
فایل اصلی: [`Neural Network/path_simulator.py`](Neural Network/path_simulator.py)

## 📖 معرفی
**path_simulator** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
