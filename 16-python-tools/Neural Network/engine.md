...
فایل اصلی: [`Neural Network/engine.py`](Neural Network/engine.py)

## 📖 معرفی
**engine** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
