...
فایل اصلی: [`Spiral Predictor.txt`](Spiral Predictor.txt)

## 📖 معرفی
**Spiral Predictor** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
