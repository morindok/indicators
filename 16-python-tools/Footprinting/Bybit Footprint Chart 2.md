...
فایل اصلی: [`Footprinting/Bybit Footprint Chart 2.txt`](Footprinting/Bybit Footprint Chart 2.txt)

## 📖 معرفی
**Bybit Footprint Chart 2** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
