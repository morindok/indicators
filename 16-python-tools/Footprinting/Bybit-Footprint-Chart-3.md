...
Source file: [`Footprinting/Bybit-Footprint-Chart-3.py`](Footprinting/Bybit-Footprint-Chart-3.py)

## Overview

**Bybit-Footprint-Chart-3** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
