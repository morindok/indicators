# Bybit-Footprint-Chart-2

> Category: [Python Tools](README.md) - Python utilities - clock, spiral, footprint, Gann, neural tools.

Source file: [`Footprinting/Bybit-Footprint-Chart-2.txt`](Footprinting/Bybit-Footprint-Chart-2.txt)

## Overview

**Bybit-Footprint-Chart-2** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
