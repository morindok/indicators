...
فایل اصلی: [`Footprinting/Footprinting System v3.txt`](Footprinting/Footprinting System v3.txt)

## 📖 معرفی
**Footprinting System v3** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
