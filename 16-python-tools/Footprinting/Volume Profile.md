...
فایل اصلی: [`Footprinting/Volume Profile.txt`](Footprinting/Volume Profile.txt)

## 📖 معرفی
**Volume Profile** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
