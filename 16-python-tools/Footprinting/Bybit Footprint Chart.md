...
فایل اصلی: [`Footprinting/Bybit Footprint Chart.txt`](Footprinting/Bybit Footprint Chart.txt)

## 📖 معرفی
**Bybit Footprint Chart** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
