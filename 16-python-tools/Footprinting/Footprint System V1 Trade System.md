...
فایل اصلی: [`Footprinting/Footprint System V1 Trade System.py`](Footprinting/Footprint System V1 Trade System.py)

## 📖 معرفی
**Footprint System V1 Trade System** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
