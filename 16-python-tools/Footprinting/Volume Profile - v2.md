...
فایل اصلی: [`Footprinting/Volume Profile - v2.txt`](Footprinting/Volume Profile - v2.txt)

## 📖 معرفی
**Volume Profile   v2** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
