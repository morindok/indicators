...
فایل اصلی: [`Footprinting/Bybit Footprint Chart 4.py`](Footprinting/Bybit Footprint Chart 4.py)

## 📖 معرفی
**Bybit Footprint Chart 4** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
