...
فایل اصلی: [`Gann/new gann/v3/chrono_engine.py`](Gann/new gann/v3/chrono_engine.py)

## 📖 معرفی
**chrono_engine** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
