...
فایل اصلی: [`Gann/new gann/v3/config.py`](Gann/new gann/v3/config.py)

## 📖 معرفی
**config** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
