...
فایل اصلی: [`Gann/new gann/v2/ChronoGann Dynamic Square.py`](Gann/new gann/v2/ChronoGann Dynamic Square.py)

## 📖 معرفی
**ChronoGann Dynamic Square** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
