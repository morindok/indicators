...
فایل اصلی: [`Gann/new gann/v1/chronogann_square.py`](Gann/new gann/v1/chronogann_square.py)

## 📖 معرفی
**chronogann_square** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
