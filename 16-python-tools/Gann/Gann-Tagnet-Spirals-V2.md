# Gann-Tagnet-Spirals-V2

> Category: [Python Tools](README.md) - Python utilities - clock, spiral, footprint, Gann, neural tools.

Source file: [`Gann/Gann-Tagnet-Spirals-V2.txt`](Gann/Gann-Tagnet-Spirals-V2.txt)

## Overview

**Gann-Tagnet-Spirals-V2** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
