...
Source file: [`Gann/Multiplier-Finder.txt`](Gann/Multiplier-Finder.txt)

## Overview

**Multiplier-Finder** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
