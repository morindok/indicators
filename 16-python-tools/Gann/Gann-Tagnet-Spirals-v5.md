# Gann-Tagnet-Spirals-v5

> Category: [Python Tools](README.md) - Python utilities - clock, spiral, footprint, Gann, neural tools.

Source file: [`Gann/Gann-Tagnet-Spirals-v5.txt`](Gann/Gann-Tagnet-Spirals-v5.txt)

## Overview

**Gann-Tagnet-Spirals-v5** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
