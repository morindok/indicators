...
Source file: [`Gann/Gann-Tagnet-Spirals.txt`](Gann/Gann-Tagnet-Spirals.txt)

## Overview

**Gann-Tagnet-Spirals** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
