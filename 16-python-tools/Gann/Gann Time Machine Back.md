...
فایل اصلی: [`Gann/Gann Time Machine Back.txt`](Gann/Gann Time Machine Back.txt)

## 📖 معرفی
**Gann Time Machine Back** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
