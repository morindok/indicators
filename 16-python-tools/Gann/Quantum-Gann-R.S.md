...
Source file: [`Gann/Quantum-Gann-R.S.txt`](Gann/Quantum-Gann-R.S.txt)

## Overview

**Quantum-Gann-R.S** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
