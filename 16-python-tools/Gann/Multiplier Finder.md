...
فایل اصلی: [`Gann/Multiplier Finder.txt`](Gann/Multiplier Finder.txt)

## 📖 معرفی
**Multiplier Finder** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
