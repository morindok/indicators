...
فایل اصلی: [`Gann/Gann Time Machine Live.txt`](Gann/Gann Time Machine Live.txt)

## 📖 معرفی
**Gann Time Machine Live** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
