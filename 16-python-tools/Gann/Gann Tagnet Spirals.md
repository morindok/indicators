...
فایل اصلی: [`Gann/Gann Tagnet Spirals.txt`](Gann/Gann Tagnet Spirals.txt)

## 📖 معرفی
**Gann Tagnet Spirals** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
