...
Source file: [`Gann/new-gann/v3/main.py`](Gann/new-gann/v3/main.py)

## Overview

**main** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "Gann/new-gann/v3/main.py"
```
