...
Source file: [`Gann/new-gann/v4/quantum_gann_dash.py`](Gann/new-gann/v4/quantum_gann_dash.py)

## Overview

**quantum_gann_dash** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
