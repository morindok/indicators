...
فایل اصلی: [`Gann/Gann Tagnet Spirals - v5.txt`](Gann/Gann Tagnet Spirals - v5.txt)

## 📖 معرفی
**Gann Tagnet Spirals   v5** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
