...
فایل اصلی: [`Gann/Time Price Tagnet Machine.txt`](Gann/Time Price Tagnet Machine.txt)

## 📖 معرفی
**Time Price Tagnet Machine** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
