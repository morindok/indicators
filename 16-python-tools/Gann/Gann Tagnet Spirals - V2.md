...
فایل اصلی: [`Gann/Gann Tagnet Spirals - V2.txt`](Gann/Gann Tagnet Spirals - V2.txt)

## 📖 معرفی
**Gann Tagnet Spirals   V2** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
