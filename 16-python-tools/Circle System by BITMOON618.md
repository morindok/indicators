...
فایل اصلی: [`Circle System by BITMOON618.txt`](Circle System by BITMOON618.txt)

## 📖 معرفی
**Circle System by BITMOON618** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
