...
فایل اصلی: [`Living Brain/3.2/add_backtest.py`](Living Brain/3.2/add_backtest.py)

## 📖 معرفی
**add_backtest** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
