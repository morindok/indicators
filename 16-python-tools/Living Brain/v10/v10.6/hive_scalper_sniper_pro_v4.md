...
فایل اصلی: [`Living Brain/v10/v10.6/hive_scalper_sniper_pro_v4.py`](Living Brain/v10/v10.6/hive_scalper_sniper_pro_v4.py)

## 📖 معرفی
**hive_scalper_sniper_pro_v4** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
