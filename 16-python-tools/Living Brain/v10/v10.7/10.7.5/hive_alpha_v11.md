...
فایل اصلی: [`Living Brain/v10/v10.7/10.7.5/hive_alpha_v11.py`](Living Brain/v10/v10.7/10.7.5/hive_alpha_v11.py)

## 📖 معرفی
**hive_alpha_v11** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
