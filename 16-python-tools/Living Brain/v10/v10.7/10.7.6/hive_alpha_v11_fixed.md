...
فایل اصلی: [`Living Brain/v10/v10.7/10.7.6/hive_alpha_v11_fixed.py`](Living Brain/v10/v10.7/10.7.6/hive_alpha_v11_fixed.py)

## 📖 معرفی
**hive_alpha_v11_fixed** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
