...
فایل اصلی: [`Living Brain/v10/v10.7/10.7.3/HIVE INSTITUTIONAL SCALPER.py`](Living Brain/v10/v10.7/10.7.3/HIVE INSTITUTIONAL SCALPER.py)

## 📖 معرفی
**HIVE INSTITUTIONAL SCALPER** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
