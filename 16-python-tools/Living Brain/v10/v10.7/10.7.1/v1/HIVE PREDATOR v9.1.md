...
فایل اصلی: [`Living Brain/v10/v10.7/10.7.1/v1/HIVE PREDATOR v9.1.py`](Living Brain/v10/v10.7/10.7.1/v1/HIVE PREDATOR v9.1.py)

## 📖 معرفی
**HIVE PREDATOR v9.1** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
