...
فایل اصلی: [`Living Brain/v3.3/living_brain.py`](Living Brain/v3.3/living_brain.py)

## 📖 معرفی
**living_brain** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
