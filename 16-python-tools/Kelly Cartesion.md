...
فایل اصلی: [`Kelly Cartesion.txt`](Kelly Cartesion.txt)

## 📖 معرفی
**Kelly Cartesion** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
