...
فایل اصلی: [`Super Analyzer/Morindok_VolumeFlow/Start.bat`](Super Analyzer/Morindok_VolumeFlow/Start.bat)

## 📖 معرفی
**Start** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
