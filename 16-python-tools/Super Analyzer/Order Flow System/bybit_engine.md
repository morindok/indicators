...
فایل اصلی: [`Super Analyzer/Order Flow System/bybit_engine.py`](Super Analyzer/Order Flow System/bybit_engine.py)

## 📖 معرفی
**bybit_engine** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
