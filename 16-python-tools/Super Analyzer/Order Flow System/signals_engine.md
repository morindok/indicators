...
فایل اصلی: [`Super Analyzer/Order Flow System/signals_engine.py`](Super Analyzer/Order Flow System/signals_engine.py)

## 📖 معرفی
**signals_engine** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
