...
فایل اصلی: [`Super Analyzer/Super Scalping System V1.txt`](Super Analyzer/Super Scalping System V1.txt)

## 📖 معرفی
**Super Scalping System V1** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
