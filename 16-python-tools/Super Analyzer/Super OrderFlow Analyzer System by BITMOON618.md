...
فایل اصلی: [`Super Analyzer/Super OrderFlow Analyzer System by BITMOON618.txt`](Super Analyzer/Super OrderFlow Analyzer System by BITMOON618.txt)

## 📖 معرفی
**Super OrderFlow Analyzer System by BITMOON618** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
