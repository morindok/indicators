...
فایل اصلی: [`Super Analyzer/Tick Data Analyzer by BITMOON618.txt`](Super Analyzer/Tick Data Analyzer by BITMOON618.txt)

## 📖 معرفی
**Tick Data Analyzer by BITMOON618** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
