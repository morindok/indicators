...
فایل اصلی: [`BTC Solar System.txt`](BTC Solar System.txt)

## 📖 معرفی
**BTC Solar System** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
