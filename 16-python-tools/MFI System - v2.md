...
فایل اصلی: [`MFI System - v2.txt`](MFI System - v2.txt)

## 📖 معرفی
**MFI System   v2** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
