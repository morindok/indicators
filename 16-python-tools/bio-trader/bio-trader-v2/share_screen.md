...
Source file: [`bio-trader/bio-trader-v2/share_screen.py`](bio-trader/bio-trader-v2/share_screen.py)

## Overview

**share_screen** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "bio-trader/bio-trader-v2/share_screen.py"
```
