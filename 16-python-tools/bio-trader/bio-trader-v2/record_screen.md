...
Source file: [`bio-trader/bio-trader-v2/record_screen.py`](bio-trader/bio-trader-v2/record_screen.py)

## Overview

**record_screen** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
