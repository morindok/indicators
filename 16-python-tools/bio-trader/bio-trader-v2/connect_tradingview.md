...
Source file: [`bio-trader/bio-trader-v2/connect_tradingview.py`](bio-trader/bio-trader-v2/connect_tradingview.py)

## Overview

**connect_tradingview** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "bio-trader/bio-trader-v2/connect_tradingview.py"
```
