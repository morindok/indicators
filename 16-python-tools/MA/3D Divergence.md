...
فایل اصلی: [`MA/3D Divergence.py`](MA/3D Divergence.py)

## 📖 معرفی
**3D Divergence** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
