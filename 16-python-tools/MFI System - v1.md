...
فایل اصلی: [`MFI System - v1.txt`](MFI System - v1.txt)

## 📖 معرفی
**MFI System   v1** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
