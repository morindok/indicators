...
فایل اصلی: [`Gravity Surface.txt`](Gravity Surface.txt)

## 📖 معرفی
**Gravity Surface** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
