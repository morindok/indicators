...
فایل اصلی: [`organism/v10/organism_2500_state.json`](organism/v10/organism_2500_state.json)

## 📖 معرفی
**organism_2500_state** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
