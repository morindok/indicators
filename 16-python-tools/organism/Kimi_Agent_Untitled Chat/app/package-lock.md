...
فایل اصلی: [`organism/Kimi_Agent_Untitled Chat/app/package-lock.json`](organism/Kimi_Agent_Untitled Chat/app/package-lock.json)

## 📖 معرفی
**package lock** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
