...
فایل اصلی: [`organism/Kimi_Agent_Untitled Chat/app/Dockerfile`](organism/Kimi_Agent_Untitled Chat/app/Dockerfile)

## 📖 معرفی
**Dockerfile** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
