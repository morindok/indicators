...
فایل اصلی: [`organism/v15/digital_organism_2500.py`](organism/v15/digital_organism_2500.py)

## 📖 معرفی
**digital_organism_2500** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
