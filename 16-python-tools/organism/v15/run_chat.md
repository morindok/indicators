...
فایل اصلی: [`organism/v15/run_chat.bat`](organism/v15/run_chat.bat)

## 📖 معرفی
**run_chat** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
