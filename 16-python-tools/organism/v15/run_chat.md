...
Source file: [`organism/v15/run_chat.bat`](organism/v15/run_chat.bat)

## Overview

**run_chat** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
