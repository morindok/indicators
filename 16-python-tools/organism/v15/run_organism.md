...
فایل اصلی: [`organism/v15/run_organism.bat`](organism/v15/run_organism.bat)

## 📖 معرفی
**run_organism** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
