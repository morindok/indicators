...
Source file: [`organism/v15/run_organism.bat`](organism/v15/run_organism.bat)

## Overview

**run_organism** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
