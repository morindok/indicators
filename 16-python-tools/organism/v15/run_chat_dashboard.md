...
فایل اصلی: [`organism/v15/run_chat_dashboard.bat`](organism/v15/run_chat_dashboard.bat)

## 📖 معرفی
**run_chat_dashboard** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
