...
فایل اصلی: [`organism/v14/organism_2500_superaware/organism_2500_superaware/organism/identity.py`](organism/v14/organism_2500_superaware/organism_2500_superaware/organism/identity.py)

## 📖 معرفی
**identity** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
