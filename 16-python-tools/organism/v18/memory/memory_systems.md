...
فایل اصلی: [`organism/v18/memory/memory_systems.py`](organism/v18/memory/memory_systems.py)

## 📖 معرفی
**memory_systems** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
