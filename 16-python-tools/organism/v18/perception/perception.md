...
فایل اصلی: [`organism/v18/perception/perception.py`](organism/v18/perception/perception.py)

## 📖 معرفی
**perception** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
