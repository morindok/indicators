...
Source file: [`organism/v18/models/vocab.json`](organism/v18/models/vocab.json)

## Overview

**vocab** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
