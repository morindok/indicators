...
فایل اصلی: [`organism/v18/models/vocab.json`](organism/v18/models/vocab.json)

## 📖 معرفی
**vocab** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
