...
فایل اصلی: [`organism/v18/models/tokenizer.json`](organism/v18/models/tokenizer.json)

## 📖 معرفی
**tokenizer** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
