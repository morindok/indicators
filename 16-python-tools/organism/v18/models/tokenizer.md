...
Source file: [`organism/v18/models/tokenizer.json`](organism/v18/models/tokenizer.json)

## Overview

**tokenizer** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
