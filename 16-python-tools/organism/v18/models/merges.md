...
Source file: [`organism/v18/models/merges.txt`](organism/v18/models/merges.txt)

## Overview

**merges** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
