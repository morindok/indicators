...
فایل اصلی: [`organism/v18/models/merges.txt`](organism/v18/models/merges.txt)

## 📖 معرفی
**merges** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
