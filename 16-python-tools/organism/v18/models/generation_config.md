...
فایل اصلی: [`organism/v18/models/generation_config.json`](organism/v18/models/generation_config.json)

## 📖 معرفی
**generation_config** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
