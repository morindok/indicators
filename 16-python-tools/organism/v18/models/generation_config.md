...
Source file: [`organism/v18/models/generation_config.json`](organism/v18/models/generation_config.json)

## Overview

**generation_config** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
