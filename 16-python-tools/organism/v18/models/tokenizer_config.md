...
Source file: [`organism/v18/models/tokenizer_config.json`](organism/v18/models/tokenizer_config.json)

## Overview

**tokenizer_config** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.
