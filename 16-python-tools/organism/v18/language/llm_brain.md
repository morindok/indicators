...
Source file: [`organism/v18/language/llm_brain.py`](organism/v18/language/llm_brain.py)

## Overview

**llm_brain** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "organism/v18/language/llm_brain.py"
```
