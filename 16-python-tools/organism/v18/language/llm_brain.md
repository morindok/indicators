...
فایل اصلی: [`organism/v18/language/llm_brain.py`](organism/v18/language/llm_brain.py)

## 📖 معرفی
**llm_brain** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
