...
Source file: [`organism/v18/cognition/cognition.py`](organism/v18/cognition/cognition.py)

## Overview

**cognition** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "organism/v18/cognition/cognition.py"
```
