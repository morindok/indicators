...
فایل اصلی: [`organism/v18/cognition/cognition.py`](organism/v18/cognition/cognition.py)

## 📖 معرفی
**cognition** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
