...
فایل اصلی: [`organism/v18/web_ui/dash_app.py`](organism/v18/web_ui/dash_app.py)

## 📖 معرفی
**dash_app** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
