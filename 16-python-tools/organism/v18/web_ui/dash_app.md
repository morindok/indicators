...
Source file: [`organism/v18/web_ui/dash_app.py`](organism/v18/web_ui/dash_app.py)

## Overview

**dash_app** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "organism/v18/web_ui/dash_app.py"
```
