...
Source file: [`organism/v18/core/types.py`](organism/v18/core/types.py)

## Overview

**types** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "organism/v18/core/types.py"
```
