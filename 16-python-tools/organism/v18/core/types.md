...
فایل اصلی: [`organism/v18/core/types.py`](organism/v18/core/types.py)

## 📖 معرفی
**types** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
