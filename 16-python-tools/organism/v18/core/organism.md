...
فایل اصلی: [`organism/v18/core/organism.py`](organism/v18/core/organism.py)

## 📖 معرفی
**organism** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
