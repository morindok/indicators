...
Source file: [`organism/v18/core/neural_substrate.py`](organism/v18/core/neural_substrate.py)

## Overview

**neural_substrate** belongs to the *Python Tools* category. Python utilities - clock, spiral, footprint, Gann, neural tools.

## How to use

```bash
python "organism/v18/core/neural_substrate.py"
```
