...
فایل اصلی: [`organism/v18/quantum_architecture.py`](organism/v18/quantum_architecture.py)

## 📖 معرفی
**quantum_architecture** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
