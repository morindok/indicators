...
فایل اصلی: [`bio trader/bio trader v2/biotrader.py`](bio trader/bio trader v2/biotrader.py)

## 📖 معرفی
**biotrader** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
