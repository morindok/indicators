...
فایل اصلی: [`bio trader/bio trader v2/bio_memory.py`](bio trader/bio trader v2/bio_memory.py)

## 📖 معرفی
**bio_memory** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
