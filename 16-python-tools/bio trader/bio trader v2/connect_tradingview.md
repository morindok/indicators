...
فایل اصلی: [`bio trader/bio trader v2/connect_tradingview.py`](bio trader/bio trader v2/connect_tradingview.py)

## 📖 معرفی
**connect_tradingview** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
