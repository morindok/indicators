...
فایل اصلی: [`bio trader/bio trader v2/share_screen.py`](bio trader/bio trader v2/share_screen.py)

## 📖 معرفی
**share_screen** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
