...
فایل اصلی: [`bio trader/bio trader v2/test_biotrader.py`](bio trader/bio trader v2/test_biotrader.py)

## 📖 معرفی
**test_biotrader** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
