...
فایل اصلی: [`bio trader/bio trader v2/neural_2500.py`](bio trader/bio trader v2/neural_2500.py)

## 📖 معرفی
**neural_2500** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
