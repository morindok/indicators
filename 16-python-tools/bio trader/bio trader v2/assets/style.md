...
فایل اصلی: [`bio trader/bio trader v2/assets/style.css`](bio trader/bio trader v2/assets/style.css)

## 📖 معرفی
**style** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
