...
فایل اصلی: [`Volume/trendline_volume_analyzer.py`](Volume/trendline_volume_analyzer.py)

## 📖 معرفی
**trendline_volume_analyzer** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
