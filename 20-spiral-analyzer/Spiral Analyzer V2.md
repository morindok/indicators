...
فایل اصلی: [`Spiral Analyzer V2.txt`](Spiral Analyzer V2.txt)

## 📖 معرفی
**Spiral Analyzer V2** یکی از اندیکاتورهای دسته «Spiral Analyzer» است. تحلیل‌گر اسپیرال — پیش‌بینی پیوت با لوگاریتمیک اسپیرال
