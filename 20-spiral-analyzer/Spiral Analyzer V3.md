...
فایل اصلی: [`Spiral Analyzer V3.txt`](Spiral Analyzer V3.txt)

## 📖 معرفی
**Spiral Analyzer V3** یکی از اندیکاتورهای دسته «Spiral Analyzer» است. تحلیل‌گر اسپیرال — پیش‌بینی پیوت با لوگاریتمیک اسپیرال
