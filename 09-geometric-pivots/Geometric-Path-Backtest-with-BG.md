# Geometric-Path-Backtest-with-BG

> Category: [Geometric Pivots](README.md) - Geometric pivots and price path projection.

Source file: [`Geometric-Path-Backtest-with-BG.txt`](Geometric-Path-Backtest-with-BG.txt)

## Overview

**Geometric-Path-Backtest-with-BG** belongs to the *Geometric Pivots* category. Geometric pivots and price path projection.
