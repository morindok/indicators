...
فایل اصلی: [`Fibo Flat Volatility Synchronized.txt`](Fibo Flat Volatility Synchronized.txt)

## 📖 معرفی
**Fibo Flat Volatility Synchronized** یکی از اندیکاتورهای دسته «Fibo Flat» است. سطح تخت فیبوناچی و خط تجمعی برای نقاط برگشت
