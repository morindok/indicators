# Fibo-Flat-Volatility-Synchronized

> Category: [Fibo Flat](README.md)

Source file: [`Fibo-Flat-Volatility-Synchronized.txt`](Fibo-Flat-Volatility-Synchronized.txt)

## Overview

Fibonacci flat levels and a cumulative line for reversal points.
