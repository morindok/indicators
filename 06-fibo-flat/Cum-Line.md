...
> Category: [Fibo Flat](README.md) - Fibonacci flat levels and cumulative line for reversal points.

Source file: [`Cum-Line.txt`](Cum-Line.txt)

## Overview

**Cum-Line** belongs to the *Fibo Flat* category. Fibonacci flat levels and cumulative line for reversal points.
