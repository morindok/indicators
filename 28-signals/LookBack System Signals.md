...
فایل اصلی: [`LookBack System Signals.txt`](LookBack System Signals.txt)

## 📖 معرفی
**LookBack System Signals** یکی از اندیکاتورهای دسته «Signals» است. اندیکاتورهای سیگنال‌ده — برگشت میرور و سیستم LookBack
