# Diamond System Trend Analyzer by @BITMOON618

> دسته: [Dragon System](README.md) — سیستم اژدها — تحلیل‌گر روند و قدرت بازار

فایل اصلی: [`Diamond System Trend Analyzer by @BITMOON618.txt`](Diamond System Trend Analyzer by @BITMOON618.txt)

## 📖 معرفی
**Diamond System Trend Analyzer by @BITMOON618** یکی از اندیکاتورهای دسته «Dragon System» است. سیستم اژدها — تحلیل‌گر روند و قدرت بازار
