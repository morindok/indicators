...
> دسته: [Voting System](README.md) — سیستم رأی‌گیری چند اندیکاتوره برای تأیید سیگنال

فایل اصلی: [`Voting System.txt`](Voting System.txt)

## 📖 معرفی
**Voting System** یکی از اندیکاتورهای دسته «Voting System» است. سیستم رأی‌گیری چند اندیکاتوره برای تأیید سیگنال
