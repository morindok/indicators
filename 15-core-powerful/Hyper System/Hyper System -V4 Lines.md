...
فایل اصلی: [`Hyper System/Hyper System -V4 Lines.txt`](Hyper System/Hyper System -V4 Lines.txt)

## 📖 معرفی
**Hyper System  V4 Lines** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
