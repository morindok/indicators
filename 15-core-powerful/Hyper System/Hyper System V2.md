...
فایل اصلی: [`Hyper System/Hyper System V2.txt`](Hyper System/Hyper System V2.txt)

## 📖 معرفی
**Hyper System V2** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
