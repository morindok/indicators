...
فایل اصلی: [`Hyper System/Hyper Fibo System Signal.txt`](Hyper System/Hyper Fibo System Signal.txt)

## 📖 معرفی
**Hyper Fibo System Signal** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
