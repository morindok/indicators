...
فایل اصلی: [`Hyper System/Hyper Symmetric MA.txt`](Hyper System/Hyper Symmetric MA.txt)

## 📖 معرفی
**Hyper Symmetric MA** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
