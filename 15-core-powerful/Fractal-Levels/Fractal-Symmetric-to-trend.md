# Fractal-Symmetric-to-trend

> Category: [Core Powerful Tools](README.md) - Core toolkit - mirror, spiral and system indicators.

Source file: [`Fractal-Levels/Fractal-Symmetric-to-trend.txt`](Fractal-Levels/Fractal-Symmetric-to-trend.txt)

## Overview

**Fractal-Symmetric-to-trend** belongs to the *Core Powerful Tools* category. Core toolkit - mirror, spiral and system indicators.
