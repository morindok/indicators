...
Source file: [`Fractal-Levels/Symmetric-Fractals.txt`](Fractal-Levels/Symmetric-Fractals.txt)

## Overview

**Symmetric-Fractals** belongs to the *Core Powerful Tools* category. Core toolkit - mirror, spiral and system indicators.
