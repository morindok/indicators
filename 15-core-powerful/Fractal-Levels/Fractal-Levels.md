...
Source file: [`Fractal-Levels/Fractal-Levels.txt`](Fractal-Levels/Fractal-Levels.txt)

## Overview

**Fractal-Levels** belongs to the *Core Powerful Tools* category. Core toolkit - mirror, spiral and system indicators.
