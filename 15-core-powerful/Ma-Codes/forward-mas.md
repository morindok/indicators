...
Source file: [`Ma-Codes/forward-mas.txt`](Ma-Codes/forward-mas.txt)

## Overview

**forward-mas** belongs to the *Core Powerful Tools* category. Core toolkit - mirror, spiral and system indicators.
