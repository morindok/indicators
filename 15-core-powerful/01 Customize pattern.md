...
فایل اصلی: [`01 Customize pattern.txt`](01 Customize pattern.txt)

## 📖 معرفی
**01 Customize pattern** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
