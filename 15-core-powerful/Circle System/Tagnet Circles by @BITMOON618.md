...
فایل اصلی: [`Circle System/Tagnet Circles by @BITMOON618.txt`](Circle System/Tagnet Circles by @BITMOON618.txt)

## 📖 معرفی
**Tagnet Circles by @BITMOON618** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
