...
فایل اصلی: [`Mirror System Sloped SImple - Reversal Signals.txt`](Mirror System Sloped SImple - Reversal Signals.txt)

## 📖 معرفی
**Mirror System Sloped SImple   Reversal Signals** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
