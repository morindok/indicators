...
فایل اصلی: [`Symmetrical Fibo Levels Prices -Reversal.txt`](Symmetrical Fibo Levels Prices -Reversal.txt)

## 📖 معرفی
**Symmetrical Fibo Levels Prices  Reversal** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
