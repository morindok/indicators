...
فایل اصلی: [`Moving Box by BITMOON618 - V2.txt`](Moving Box by BITMOON618 - V2.txt)

## 📖 معرفی
**Moving Box by BITMOON618   V2** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
