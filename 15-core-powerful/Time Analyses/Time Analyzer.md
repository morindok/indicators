...
فایل اصلی: [`Time Analyses/Time Analyzer.txt`](Time Analyses/Time Analyzer.txt)

## 📖 معرفی
**Time Analyzer** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
