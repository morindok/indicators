...
فایل اصلی: [`Bitmoon System/Bitmoon System Pro - V2.txt`](Bitmoon System/Bitmoon System Pro - V2.txt)

## 📖 معرفی
**Bitmoon System Pro   V2** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
