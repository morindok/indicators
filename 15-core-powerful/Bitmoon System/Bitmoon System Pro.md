...
فایل اصلی: [`Bitmoon System/Bitmoon System Pro.txt`](Bitmoon System/Bitmoon System Pro.txt)

## 📖 معرفی
**Bitmoon System Pro** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
