...
فایل اصلی: [`Bitmoon System/Mirror System Signals.txt`](Bitmoon System/Mirror System Signals.txt)

## 📖 معرفی
**Mirror System Signals** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
