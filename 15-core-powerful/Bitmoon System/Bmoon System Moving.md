...
فایل اصلی: [`Bitmoon System/Bmoon System Moving.txt`](Bitmoon System/Bmoon System Moving.txt)

## 📖 معرفی
**Bmoon System Moving** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
