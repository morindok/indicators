...
فایل اصلی: [`Fractal Mirror Levels/Fracta Mirror Levels.txt`](Fractal Mirror Levels/Fracta Mirror Levels.txt)

## 📖 معرفی
**Fracta Mirror Levels** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
