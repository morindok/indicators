...
فایل اصلی: [`Fractal Levels/Symmetric Fractals.txt`](Fractal Levels/Symmetric Fractals.txt)

## 📖 معرفی
**Symmetric Fractals** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
