...
فایل اصلی: [`Fractal Levels/Fractal Levels.txt`](Fractal Levels/Fractal Levels.txt)

## 📖 معرفی
**Fractal Levels** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
