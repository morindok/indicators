...
فایل اصلی: [`Fractal Levels/Fractal Symmetric to trend.txt`](Fractal Levels/Fractal Symmetric to trend.txt)

## 📖 معرفی
**Fractal Symmetric to trend** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
