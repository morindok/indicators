...
فایل اصلی: [`Zero-Lag Fractal Moving.txt`](Zero-Lag Fractal Moving.txt)

## 📖 معرفی
**Zero Lag Fractal Moving** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
