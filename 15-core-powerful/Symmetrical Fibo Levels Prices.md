...
فایل اصلی: [`Symmetrical Fibo Levels Prices.txt`](Symmetrical Fibo Levels Prices.txt)

## 📖 معرفی
**Symmetrical Fibo Levels Prices** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
