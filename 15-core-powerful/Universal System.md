...
فایل اصلی: [`Universal System.txt`](Universal System.txt)

## 📖 معرفی
**Universal System** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
