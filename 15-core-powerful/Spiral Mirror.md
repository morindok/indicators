...
فایل اصلی: [`Spiral Mirror.txt`](Spiral Mirror.txt)

## 📖 معرفی
**Spiral Mirror** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
