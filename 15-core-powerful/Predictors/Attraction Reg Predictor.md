...
فایل اصلی: [`Predictors/Attraction Reg Predictor.txt`](Predictors/Attraction Reg Predictor.txt)

## 📖 معرفی
**Attraction Reg Predictor** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
