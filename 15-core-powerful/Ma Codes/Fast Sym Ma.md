...
فایل اصلی: [`Ma Codes/Fast Sym Ma.txt`](Ma Codes/Fast Sym Ma.txt)

## 📖 معرفی
**Fast Sym Ma** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
