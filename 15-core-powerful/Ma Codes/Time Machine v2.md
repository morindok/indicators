...
فایل اصلی: [`Ma Codes/Time Machine v2.txt`](Ma Codes/Time Machine v2.txt)

## 📖 معرفی
**Time Machine v2** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
