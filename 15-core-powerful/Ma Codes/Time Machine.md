...
فایل اصلی: [`Ma Codes/Time Machine.txt`](Ma Codes/Time Machine.txt)

## 📖 معرفی
**Time Machine** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
