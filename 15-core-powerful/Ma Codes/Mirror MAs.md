...
فایل اصلی: [`Ma Codes/Mirror MAs.txt`](Ma Codes/Mirror MAs.txt)

## 📖 معرفی
**Mirror MAs** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
