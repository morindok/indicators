...
فایل اصلی: [`Spiral Symmetric.txt`](Spiral Symmetric.txt)

## 📖 معرفی
**Spiral Symmetric** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
