...
فایل اصلی: [`Mirror Moon/Moon Layers V3 Signal.txt`](Mirror Moon/Moon Layers V3 Signal.txt)

## 📖 معرفی
**Moon Layers V3 Signal** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
