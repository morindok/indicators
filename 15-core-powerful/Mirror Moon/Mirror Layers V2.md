...
فایل اصلی: [`Mirror Moon/Mirror Layers V2.txt`](Mirror Moon/Mirror Layers V2.txt)

## 📖 معرفی
**Mirror Layers V2** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
