...
فایل اصلی: [`Mirror Moon/Bitmoon System Pro V1.txt`](Mirror Moon/Bitmoon System Pro V1.txt)

## 📖 معرفی
**Bitmoon System Pro V1** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
