...
فایل اصلی: [`Mirror Moon/Mirror Layers.txt`](Mirror Moon/Mirror Layers.txt)

## 📖 معرفی
**Mirror Layers** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
