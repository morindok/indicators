...
فایل اصلی: [`Mirror Moon/Bitmoon System Pro V3.txt`](Mirror Moon/Bitmoon System Pro V3.txt)

## 📖 معرفی
**Bitmoon System Pro V3** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
