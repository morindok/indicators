...
فایل اصلی: [`Mirror Moon/Mirror Moon.txt`](Mirror Moon/Mirror Moon.txt)

## 📖 معرفی
**Mirror Moon** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
