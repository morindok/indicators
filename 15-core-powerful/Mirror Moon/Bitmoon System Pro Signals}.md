...
فایل اصلی: [`Mirror Moon/Bitmoon System Pro Signals}.txt`](Mirror Moon/Bitmoon System Pro Signals}.txt)

## 📖 معرفی
**Bitmoon System Pro Signals}** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
