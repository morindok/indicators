...
فایل اصلی: [`Spiral Fractal.txt`](Spiral Fractal.txt)

## 📖 معرفی
**Spiral Fractal** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
