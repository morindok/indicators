...
Source file: [`Hyper-System/Hyper-Symmetric-MA.txt`](Hyper-System/Hyper-Symmetric-MA.txt)

## Overview

**Hyper-Symmetric-MA** belongs to the *Core Powerful Tools* category. Core toolkit - mirror, spiral and system indicators.
