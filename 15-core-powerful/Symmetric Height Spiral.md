...
فایل اصلی: [`Symmetric Height Spiral.txt`](Symmetric Height Spiral.txt)

## 📖 معرفی
**Symmetric Height Spiral** یکی از اندیکاتورهای دسته «Core Powerful Tools» است. مجموعه‌ی اصلی و قدرتمند — میرور، اسپیرال، سیستمی
