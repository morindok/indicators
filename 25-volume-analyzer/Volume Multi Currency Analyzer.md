...
فایل اصلی: [`Volume Multi Currency Analyzer.txt`](Volume Multi Currency Analyzer.txt)

## 📖 معرفی
**Volume Multi Currency Analyzer** یکی از اندیکاتورهای دسته «Volume Analyzer» است. تحلیل‌گر حجم — زون‌های قدرت حجم و داشبورد
