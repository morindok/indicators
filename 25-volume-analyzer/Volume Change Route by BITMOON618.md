...
فایل اصلی: [`Volume Change Route by BITMOON618.txt`](Volume Change Route by BITMOON618.txt)

## 📖 معرفی
**Volume Change Route by BITMOON618** یکی از اندیکاتورهای دسته «Volume Analyzer» است. تحلیل‌گر حجم — زون‌های قدرت حجم و داشبورد
