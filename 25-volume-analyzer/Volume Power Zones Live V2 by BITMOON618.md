# Volume Power Zones Live V2 by BITMOON618

> دسته: [Volume Analyzer](README.md) — تحلیل‌گر حجم — زون‌های قدرت حجم و داشبورد

فایل اصلی: [`Volume Power Zones Live V2 by BITMOON618.txt`](Volume Power Zones Live V2 by BITMOON618.txt)

## 📖 معرفی
**Volume Power Zones Live V2 by BITMOON618** یکی از اندیکاتورهای دسته «Volume Analyzer» است. تحلیل‌گر حجم — زون‌های قدرت حجم و داشبورد
