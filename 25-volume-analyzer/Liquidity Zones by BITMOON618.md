...
فایل اصلی: [`Liquidity Zones by BITMOON618.txt`](Liquidity Zones by BITMOON618.txt)

## 📖 معرفی
**Liquidity Zones by BITMOON618** یکی از اندیکاتورهای دسته «Volume Analyzer» است. تحلیل‌گر حجم — زون‌های قدرت حجم و داشبورد
