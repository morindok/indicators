...
فایل اصلی: [`Volume Power Zones Live V4 by BITMOON618.pine`](Volume Power Zones Live V4 by BITMOON618.pine)

## 📖 معرفی
**Volume Power Zones Live V4 by BITMOON618** یکی از اندیکاتورهای دسته «Volume Analyzer» است. تحلیل‌گر حجم — زون‌های قدرت حجم و داشبورد
