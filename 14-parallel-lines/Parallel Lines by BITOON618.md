...
فایل اصلی: [`Parallel Lines by BITOON618.txt`](Parallel Lines by BITOON618.txt)

## 📖 معرفی
**Parallel Lines by BITOON618** یکی از اندیکاتورهای دسته «Parallel Lines» است. خطوط موازی زنده و شبکه هارمونیک مارکوف-بیز
