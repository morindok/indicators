...
فایل اصلی: [`Parallel Lines Live v2 by BITMOON618.txt`](Parallel Lines Live v2 by BITMOON618.txt)

## 📖 معرفی
**Parallel Lines Live v2 by BITMOON618** یکی از اندیکاتورهای دسته «Parallel Lines» است. خطوط موازی زنده و شبکه هارمونیک مارکوف-بیز
