...
Source file: [`Time-Analyzer.txt`](Time-Analyzer.txt)

## Overview

**Time-Analyzer** belongs to the *Super Mirror* category. Super Mirror - price reflection, oscillator and time analysis.
