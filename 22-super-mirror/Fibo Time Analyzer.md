...
فایل اصلی: [`Fibo Time Analyzer.txt`](Fibo Time Analyzer.txt)

## 📖 معرفی
**Fibo Time Analyzer** یکی از اندیکاتورهای دسته «Super Mirror» است. ابَرمیرور — بازتاب قیمت، اسیلاتور و تحلیل زمان
