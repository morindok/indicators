...
فایل اصلی: [`BOS Oscilator Boxes.txt`](BOS Oscilator Boxes.txt)

## 📖 معرفی
**BOS Oscilator Boxes** یکی از اندیکاتورهای دسته «Super Mirror» است. ابَرمیرور — بازتاب قیمت، اسیلاتور و تحلیل زمان
