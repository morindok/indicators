...
Source file: [`Fibo-Time-Analyzer.txt`](Fibo-Time-Analyzer.txt)

## Overview

**Fibo-Time-Analyzer** belongs to the *Super Mirror* category. Super Mirror - price reflection, oscillator and time analysis.
