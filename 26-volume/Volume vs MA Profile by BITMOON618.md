...
> دسته: [Volume](README.md) — کندل‌های حجمی و پروفایل حجم-میانگین

فایل اصلی: [`Volume vs MA Profile by BITMOON618.txt`](Volume vs MA Profile by BITMOON618.txt)

## 📖 معرفی
**Volume vs MA Profile by BITMOON618** یکی از اندیکاتورهای دسته «Volume» است. کندل‌های حجمی و پروفایل حجم-میانگین
