# Bmoon System Zigzag Fractals v2

> دسته: [Bitmoon System](README.md) — سیستم کامل Bitmoon — ترکیب میرور، سیگنال و اسیلاتور

فایل اصلی: [`Bmoon System Zigzag Fractals v2.txt`](Bmoon System Zigzag Fractals v2.txt)

## 📖 معرفی
**Bmoon System Zigzag Fractals v2** یکی از اندیکاتورهای دسته «Bitmoon System» است. سیستم کامل Bitmoon — ترکیب میرور، سیگنال و اسیلاتور
