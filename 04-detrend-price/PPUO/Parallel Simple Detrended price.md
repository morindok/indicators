# Parallel Simple Detrended price

> دسته: [Detrend Price](README.md) — حذف روند از قیمت (Detrend) برای دیدن چرخه‌های خالص

فایل اصلی: [`PPUO/Parallel Simple Detrended price.txt`](PPUO/Parallel Simple Detrended price.txt)

## 📖 معرفی
**Parallel Simple Detrended price** یکی از اندیکاتورهای دسته «Detrend Price» است. حذف روند از قیمت (Detrend) برای دیدن چرخه‌های خالص
