...
Source file: [`PPUO/Parallel-Simple-Detrended-price.txt`](PPUO/Parallel-Simple-Detrended-price.txt)

## Overview

**Parallel-Simple-Detrended-price** belongs to the *Detrend Price* category. Removing trend from price to reveal pure cycles.
