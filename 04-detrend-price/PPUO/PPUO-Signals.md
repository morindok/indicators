...
Source file: [`PPUO/PPUO-Signals.txt`](PPUO/PPUO-Signals.txt)

## Overview

**PPUO-Signals** belongs to the *Detrend Price* category. Removing trend from price to reveal pure cycles.
