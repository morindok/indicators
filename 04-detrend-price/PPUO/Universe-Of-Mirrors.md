...
Source file: [`PPUO/Universe-Of-Mirrors.txt`](PPUO/Universe-Of-Mirrors.txt)

## Overview

**Universe-Of-Mirrors** belongs to the *Detrend Price* category. Removing trend from price to reveal pure cycles.
