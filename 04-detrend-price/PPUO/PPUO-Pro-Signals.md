...
Source file: [`PPUO/PPUO-Pro-Signals.txt`](PPUO/PPUO-Pro-Signals.txt)

## Overview

**PPUO-Pro-Signals** belongs to the *Detrend Price* category. Removing trend from price to reveal pure cycles.
